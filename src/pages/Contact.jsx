						...
						<form action="" method="post">
							...
							<div>
								<div className="flex flex-col w-full mt-8">
									...
									<textarea
										type="text"
										className="h-40 p-3 leading-none text-gray-900 bg-gray-100 border border-gray-200 rounded mt-2text-base focus:oultine-none focus:border-blue-700"></textarea>
								</div>
							</div>
