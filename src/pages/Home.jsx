    ...
    <video
      ...
      <div className='w-full h-[90%] flex flex-col justify-center items-center text-white px-4 text-center'>
        ...
        <p className='py-4 text-xl'>
           Creating a better and holistic life for many people with innovative technologies, products and designs
          
        </p>
        <div>
          <button className='m-2 duration-300 transition animate-bounce'>Use Defi</button>
